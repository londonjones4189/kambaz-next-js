  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <li>Mix dry ingredients.</li>
          <li>Boil cabbage.</li>
          <li>Cook beef and rice.</li>
          <li>Roll cabbage around beef and rice.</li>
          <li>Pour red sauce over rolls.</li>
          <li>Pour chicken stock over rolls.</li>
          <li>Place in oven.</li>
          <li>Serve and enjoy!</li>
        </ol>
